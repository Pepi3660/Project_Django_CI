...
SECRET_KEY = 'django-insecure-)z1g#b1icd2(%vs1_((j&la*xa-*@np7is-!7(j2y&t_fr7)=$'
...
LANGUAGE_CODE = 'en-ni' #? This is set to 'en-ni' for Nicaraguan English, adjust as needed.

TIME_ZONE = 'America/Managua' #? This is set to 'America/Managua' for Nicaragua, adjust as needed.
